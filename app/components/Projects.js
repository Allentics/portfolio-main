        ...
        <section id="work" className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <p className="text-purple-600 font-semibold text-lg">{content?.headerTitle || "My Work"}</p>
                    <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mt-2">
                        {content?.headerSubtitle || "Featured Projects"}
                    </h2>
                    <p className="text-gray-600 text-lg mt-4">
                        {content?.headerDescription || "A selection of my recent work and personal projects."}
                    </p>
                </div>
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        {project.github_url && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="p-2 bg-white rounded-full text-gray-900 hover:bg-gray-900 hover:text-white transition-colors"
                                            >
