export default function Footer({ sitename, description, socialLinks }) {
                ...
                <div className="grid md:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-400 max-w-xs">
                            {description || "Creating beautiful digital experiences with passion and precision."}
                        </p>
                        {/* Social Links */}
                    ...
                    <div>
                        ...
                        <form className="flex gap-2">
                            <input
                                ...
                                className="flex-1 px-4 py-2 rounded-lg bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all"
                            />
                            <button
                                type="submit"
                                className="px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-500 rounded-lg font-medium hover:shadow-lg transition-all"
                            >
                                Subscribe
                            </button>
                        </form>
